            ...
            public string user {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'user\' de la tabla \'login\' es DBNull.", e);
                    }
                }
                set {
...
namespace login.loginDataSetTableAdapters {
    ...
    public partial class loginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `login` WHERE ((`Id` = ?) AND ((? = 1 AND `user` IS NULL) OR (`user` " +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `login` SET `user` = ?, `password` = ? WHERE ((`Id` = ?) AND ((? = 1 AND `" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, [user], [password] FROM login";
